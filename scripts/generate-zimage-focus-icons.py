...
FOCUS_DESCRIPTIONS = {
    "BLHM_GER_develop_portuguese_mining": (
        "вольфрамовый рудник в горах Португалии, вагонетка с кристаллами вольфрама, "
        "скрещённые кирка и бур, индустриальная добыча"
    ),
    "BLHM_GER_invest_in_italian_industry": (
        "итальянский промышленный завод, дымящие трубы, сталелитейный цех, "
        "шестерни и индустриальные элементы"
    ),
    "BLHM_GER_libyan_industry": (
        "нефтяная вышка в ливийской пустыне, буровая установка, песчаные дюны, "
        "добыча нефти и ресурсов"
    ),
    "BLHM_GER_mediterranean_exercises": (
        "военно-морские учения в Средиземном море, военный корабль, "
        "самолёт над водой, морская авиация"
    ),
    "BLHM_GER_prepare_east_african_sabotage": (
        "саботаж и подрывная деятельность, взрывчатка, секретная операция, "
        "карта Африки, разрушенная железная дорога"
    ),
    "BLHM_GER_spanish_african_bases": (
        "военно-морская база в испанской Африке, док для кораблей, "
        "маяк, портовые сооружения"
    ),
    "BLHM_GER_wunderwaffe_program": (
        "секретная лаборатория чудесного оружия, чертежи ракет и танков, "
        "учёные в лабораторных халатах, секретные разработки"
    ),
    "GER_consolidate_management_of_minor_powers": (
        "объединение малых держав под германским руководством, карта Венгрии "
        "Румынии и Болгарии, символы промышленного союза"
    ),
    "GER_develop_hungarian_bauxite_deposits": (
        "венгерские бокситовые рудники, добыча алюминиевой руды, "
        "карьерные экскаваторы, горы бокситов"
    ),
    "GER_diplomatic_pressure_on_potential_allies": (
        "дипломатическое давление, рукопожатие на фоне карт Европы, "
        "договоры и документы, политическое влияние"
    ),
    "GER_east_front_continue_offensive": (
        "восточный фронт, непрерывное наступление, немецкие танки в атаке, "
        "дым и огонь боя, красные стрелки на карте"
    ),
    "GER_east_front_defensive_tactics": (
        "оборонительная тактика, окопы, пулемётные гнёзда, "
        "колючая проволока, противотанковые ежи"
    ),
    "GER_east_front_destroy_partisans": (
        "борьба с партизанами, лесная засада, военные патрули, "
        "карта партизанских районов"
    ),
    "GER_east_front_final_blow": (
        "финальный удар по врагу, массированная артиллерийская атака, "
        "залп ракет, решающее сражение"
    ),
    "GER_east_front_fortify_lines": (
        "укрепление оборонительных линий, бункеры, бетонные укрепления, "
        "противотанковые рвы, доты"
    ),
    "GER_east_front_prepare_long_war": (
        "подготовка к затяжной войне, карта с линиями снабжения, "
        "грузовики с припасами, военные склады"
    ),
    "GER_east_front_prepare_second_winter": (
        "подготовка ко второй зиме, зимнее обмундирование, "
        "снежные заносы, обогреватели на фронте"
    ),
    "GER_east_front_summer_campaign": (
        "летняя кампания на восточном фронте, танковая колонна в степи, "
        "пыльные дороги, летнее наступление"
    ),
    "GER_east_front_supply_routes": (
        "маршруты снабжения, грузовые поезда, железные дороги, "
        "транспортные колонны, логистика фронта"
    ),
    "GER_east_front_victory_or_death": (
        "победа или смерть, решительная атака, знамя в дыму боя, "
        "последний рывок к победе"
    ),
    "GER_east_front_win_before_winter": (
        "победа до зимы, спешное наступление, календарь с отметками, "
        "гонка со временем"
    ),
    "GER_expand_oil_extraction_in_ploesti": (
        "нефтедобыча в Плоешти, нефтяные вышки Румынии, "
        "нефтеперерабатывающий завод, топливные цистерны"
    ),
    "GER_integrate_czech_manufacturers": (
        "чешские производители вооружений, заводы Шкода, "
        "производство танков и оружия, интеграция промышленности"
    ),
    "GER_sofia_initiative": (
        "софийская инициатива, болгарский парламент, дипломатические переговоры, "
        "влияние Германии на Балканах"
    ),
    "GER_wunderwaffe_e50": (
        "танк E-50, средний танк нового поколения, мощная пушка, "
        "наклонная броня, серийное производство"
    ),
    "GER_wunderwaffe_e50_unification": (
        "унификация танкового производства E-50, стандаризация деталей, "
        "конвейерная сборка, чертежи танков"
    ),
    "GER_wunderwaffe_maus": (
        "сверхтяжёлый танк Маус, лобовая броня, пушка 128мм, "
        "стальные гусеницы, гигантский размер"
    ),
    "GER_wunderwaffe_me262": (
        "реактивный истребитель Me-262, реактивные двигатели, "
        "стреловидное крыло, скорость и мощь люфтваффе"
    ),
    "GER_wunderwaffe_rotte": (
        "схема боевого порядка Rotte, тактика парной авиации, "
        "два истребителя в строю, воздушный бой"
    ),
    "SOV_mobilization_first_wave": (
        "первая волна мобилизации, призывники с винтовками, "
        "военкомат, красные знамёна, массовый призыв"
    ),
    "SOV_mobilization_second_wave": (
        "вторая волна мобилизации, резервисты в форме, "
        "эшелоны с войсками, военная подготовка"
    ),
    "SOV_operation_bagration": (
        "операция Багратион, масштабное советское наступление, "
        "катюши, танки Т-34, освобождение Беларуси"
    ),
    "SOV_order_227": (
        "приказ №227 Ни шагу назад!, советский солдат с винтовкой, "
        "заградотряд, красный флаг, запрет на отступление"
    ),
}
